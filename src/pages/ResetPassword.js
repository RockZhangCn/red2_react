...
function ResetPassword() {
    ...
    const handleSubmit = (e) => {
        ...
        console.log('Password reset submitted', { email, newPassword, confirmPassword, securityCode });
    };
                        ...
                        <form onSubmit={handleSubmit} className="p-4 border rounded shadow">
                            ...
                            <div className="mb-3">
                                ...
                                <input
                                    ...
                                    required
                                />
                                <small className="form-text text-muted">Enter the security code sent to your email.</small>
                            </div>
                            <div className="d-grid gap-2">
                                <button type="submit" className="btn btn-primary" disabled={!passwordsMatch}>Reset Password</button>
