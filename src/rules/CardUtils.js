...
function GetCardPattern(cards) {
    ...
    if (cnt === 1) {
        ...
        if (valueSetLen === 2) {
            if ((Math.floor(cards[0] / 4) === Math.floor(cards[1] / 4) && Math.floor(cards[1] / 4) === Math.floor(cards[2] / 4)) || 
                (Math.floor(cards[3] / 4) === Math.floor(cards[1] / 4) && Math.floor(cards[1] / 4) === Math.floor(cards[2] / 4))) {
        ...
        if (valueSetLen === 2) {
            if ((Math.floor(cards[0] / 4) === Math.floor(cards[1] / 4) && Math.floor(cards[1] / 4) === Math.floor(cards[2] / 4) && Math.floor(cards[4] / 4) === Math.floor(cards[3] / 4)) || 
                (Math.floor(cards[0] / 4) === Math.floor(cards[1] / 4) && Math.floor(cards[2] / 4) === Math.floor(cards[3] / 4) && Math.floor(cards[3] / 4) === Math.floor(cards[4] / 4))) {
        ...
        if (cnt % 5 === 0 && Math.floor(cnt / 5) <= valueSetLen && valueSetLen <= Math.floor(cnt / 5) * 2) {
            return CardPattern.MODE_AIRPLANE_TWE;
        }
        if (cnt % 4 === 0 && Math.floor(cnt / 4) <= valueSetLen && valueSetLen <= Math.floor(cnt / 4) * 2) {
